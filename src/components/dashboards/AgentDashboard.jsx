      ...
      try {
        ...
        const totalEarnings =
          agentReservations.reduce(
            (sum, r) => sum + r.amount_usd * (agentRecord?.commission_rate || 0.1),
            0
          ) +
        ...
        setStats({
          ...
          activeCases: cases.filter((c) => !["Approved", "Rejected"].includes(c.status))
            .length,
          totalEarnings,
              ...
              {recentCases.length > 0 ? (
                    ...
                    >
                      <div>
                        ...
                        <p className="text-xs text-gray-500">
                          {format(new Date(caseData.created_date), "MMM dd, yyyy")}
                        </p>
                      </div>
                      <Badge
                ...
                <div className="text-center py-6">
                  ...
                  <p className="text-sm text-gray-500">
                    Cases will appear when students purchase packages
                  </p>
                </div>
              )}
            </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-bold text-green-600">
              {recentCases.length > 0
                ? ((stats.approvedCases / recentCases.length) * 100).toFixed(1)
                : 0}
              %
            </div>
