  ...
  useEffect(() => {
    const loadTeamContent = async () => {
      try {
        ...
        setTeamContent(snap.exists() ? { id: snap.id, ...snap.data() } : null);
      } catch (error) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        ...
        >
          ...
          <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
            Our team is here to help you every step of the way. From program
            selection to visa application, we're committed to making your study
